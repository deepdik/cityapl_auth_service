...
#     """
#     Note that the exception handler will only be called for
#     responses generated by raised exceptions. It will not be
#     used for any responses returned directly by the view, such
#     as the HTTP_400_BAD_REQUEST responses that are returned by
